...
public class SearchCoursePage extends PageObject {
    public static final Target BUTTON_UC = Target.the("Seleecciona la universidad choucair")
    ...
    public static final Target NAME_COURSE = Target.the("Extrae el nomnbre del curso")
